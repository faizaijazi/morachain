...
const Worldfirst = () => {
  ...
  return (
    <div style={{
    ...
    }} className="lady relative mt-[200px] lg:mt-[0px] flex justify-center pb-[50px] h-[1050px] sm:h-[1000px] md:h-[1100px] lg:h-[620px]">
      ...
      <div className="w-full lg:w-[50%] flex justify-center md:justify-end ">
        <img src={lady} alt="" className="md:h-[700px]" />
      </div>
      </div>
    </div>
  );
