  ...
  return (
    ...
    <div className=" px-[20px] py-16 mx-auto flex flex-wrap bg-[#0a0d10] xl:pr-[200px]">
      <div className='md:w-2/4 flex items-end md:relative'>
          <img src={house} alt="" className='md:absolute md:top-[100px] md:left-[-70px]  xl:h-[400px] lg:top-[130px] xl:top-[120px] 2xl:top-[70px]' />
      </div>
