...
function Play() {
    ...
    return (
        ...
        }} className="mb-[100px] bg-slate-600 pt-[130px] md:pt-[0px] md:h-[700px] xl:flex xl:justify-center">
              <div className="h-full flex justify-center xl:items-center  md:justify-end  xl:w-[75%]">
              <div className="flex justify-center md:flex-col flex-wrap px-[20px] md:h-[600px] w-[700px] md:pt-[100px]">
                ...
                }} className="p-[8px] xl:px-[15px] rounded-[17px]">
