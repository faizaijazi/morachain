...
const Morachain = () => {
  ...
  <div className="container px-8 md:px-[20px]  2xl:px-[100px] lg:px-10 pt-24  pb-[20px] md:pb-[0px] mx-auto flex flex-col md:flex-row flex-wrap md:flex-nowrap">
    <div className="lg:w-3/5 md:w-1/2 md:pr-[2rem] lg:pr-[4rem] pr-0 mt-[60px]">
      <h1 className="title-font font-medium text-[2.5rem] sm:text-[3rem] 2xl:text-[4rem] text-gray-900">What is Morachain?</h1>
